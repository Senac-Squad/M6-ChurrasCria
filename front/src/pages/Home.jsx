...
import NotaSlider from "../components/UI/slider/NotaSlider";
...
const Home = () => {
  ...
  useEffect(() => {
    async function fetchRestaurantes() {
      try {
        const response = await axios.get(`http://localhost:3001/restaurante`);
            ...
            <Col lg="6" md="6">
              <div className="hero__content">
                ...
                <p>
                  ...
                  Ratione iusto libero, earum saepe facilis explicabo dolor esse
                  aperiam voluptatem eius laborum inventore qui!
                </p>
            ...
            <Col lg="6" md="6">
              <div className="why__tasty-treat">
                ...
                <p className="tasty__treat-desc">
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                  Quasi, hic. Lorem ipsum dolor sit amet consectetur adipisicing
                  elit. Aliquam possimus laudantium expedita ducimus asperiores,
                  sapiente nisi tempora placeat, ullam quasi ut. Eum similique
                  doloremque earum quam! Iusto rerum iure consequuntur.
                </p>

                <ListGroup className="mt-4">
                  <ListGroupItem className="border-0 ps-0">
                    <p className=" choose__us-title d-flex align-items-center gap-2">
                      <i className=" ri-checkbox-circle-line"></i> Alimentos
                      frescos e saborosos
                    </p>
                  ...
                  <ListGroupItem className="border-0 ps-0">
                    <p className=" choose__us-title d-flex align-items-center gap-2">
                      <i className=" ri-checkbox-circle-line"></i> Suporte de
                      qualidade
                    </p>
                    <p className=" choose__us-desc">
                      Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  ...
                  <ListGroupItem className="border-0 ps-0">
                    <p className=" choose__us-title d-flex align-items-center gap-2">
                      <i className=" ri-checkbox-circle-line"></i> Peça de
                      qualquer lugar{" "}
                    </p>
                    <p className=" choose__us-desc">
                      Lorem ipsum dolor sit, amet consectetur adipisicing elit.
          ...
          <Row>
            <Col lg="6" md="6">
              <div className="depoimento ">
                <h5 className="depoimento__subtitle mb-4">Avaliações</h5>
                <h2 className="depoimento__title mb-4">
                  Oque nossos <span>clientes </span>estão dizendo
                </h2>
